...
The skill was written by the engineer who has shipped this module; `references/provenance.md` records the ten defects the audit found in the earlier implementation and how the templates fix them. That file is the rationale layer for the whole skill.
